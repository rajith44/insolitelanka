...
export const changeLayoutPosition = createAction('[Layout] Set TopbarMode', props<{ layoutposition: boolean }>());
export const changeSidebarSize = createAction('[Layout] Set TopbarMode', props<{ sidebarsize: string }>());
