(function ($) {
	...
	jQuery(window).on('load', function () {
		$(".egns-preloader").delay(600).fadeOut("slow");
	});
	...
	//home1-banner-slider - initialized by Angular (Home component) when view is ready; skip here for SPA
	var home1BannerEl = document.querySelector(".home1-banner-slider");
	if (home1BannerEl) {
	...
	// package-card-tab-slider - initialized by Angular (Home component) when view is ready; skip here for SPA
	// testimonial-card-slider - initialized by Angular (Home component) when view is ready; skip here for SPA
